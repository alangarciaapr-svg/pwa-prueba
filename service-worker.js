const CACHE_NAME = 'iaptidud-supervision-v23';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    // Fuerza una recarga al activar esta versión para incorporar Auth offline,
...
async function addAppScripts(response) {
  ...
  // se agregan al final del body respetando dependencias: Storage y Video antes de Sync.
